...
import (
	...
	output "github.com/nayakunin/gophkeeper/internal/commands/get/password/output"
...
func (m *MockOutput) MakeResponse(response *generated.GetLoginPasswordPairsResponse, encryptionKey []byte) ([]output.PasswordResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MakeResponse", response, encryptionKey)
	ret0, _ := ret[0].([]output.PasswordResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
