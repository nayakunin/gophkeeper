...
import (
	...
	output "github.com/nayakunin/gophkeeper/internal/commands/get/card/output"
...
func (m *MockOutput) MakeResponse(response *generated.GetBankCardDetailsResponse, encryptionKey []byte) ([]output.CardResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MakeResponse", response, encryptionKey)
	ret0, _ := ret[0].([]output.CardResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
